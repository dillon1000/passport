...
/**
 * Compact status and metadata label. Callers configure meaning through the
 * semantic variant while this primitive owns focus, color, and transition
 * behavior for both plain spans and `asChild` interactive badges.
 */
