/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=/Users/dillon/Developer/passport/wrangler.jsonc /Users/dillon/Developer/passport/worker-configuration.d.ts` (hash: 07548961bbc41f2f3b5a0451cd653c43)
// Runtime types generated with workerd@1.20260820.1 2026-06-14 nodejs_compat
interface __BaseEnv_Env {
	...
	ACCOUNT_LOCKOUT_COOLDOWN_SECONDS: "900";
	STRIPE_API_VERSION: "2026-07-29.dahlia";
	STRIPE_CREATE_CUSTOMER_ON_SIGN_UP: "true";
	STRIPE_BILLING_REQUIRE_EMAIL_VERIFICATION: "true";
	STRIPE_CHECKOUT_ALLOW_PROMOTION_CODES: "true";
	STRIPE_CHECKOUT_AUTOMATIC_TAX_ENABLED: "false";
	STRIPE_CHECKOUT_BILLING_ADDRESS_COLLECTION: "auto";
	STRIPE_CHECKOUT_TAX_ID_COLLECTION_ENABLED: "false";
	STRIPE_BILLING_PLANS: "[{\"name\":\"pro\",\"label\":\"Pro\",\"description\":\"Production auth and billing features.\",\"priceId\":\"price_replace_monthly\",\"annualDiscountPriceId\":\"price_replace_yearly\",\"limits\":{\"applications\":10,\"organizations\":3},\"entitlements\":[\"oauth\",\"billing\"],\"freeTrialDays\":14},{\"name\":\"team\",\"label\":\"Team\",\"description\":\"Organization billing with seat sync.\",\"priceId\":\"price_replace_team_monthly\",\"annualDiscountPriceId\":\"price_replace_team_yearly\",\"seatPriceId\":\"price_replace_team_seat\",\"limits\":{\"applications\":50,\"organizations\":10,\"members\":100},\"entitlements\":[\"oauth\",\"billing\",\"organizations\",\"seats\"]}]";
	...
	AUTH_SECONDARY_STORAGE_COORDINATOR: DurableObjectNamespace<import("./worker/index").AuthSecondaryStorage>;
	DATA_EXPORT_WORKFLOW: Workflow<Parameters<import("./worker/index").DataExportWorkflow['run']>[0]['payload']>;
	WEBHOOK_DELIVERY_WORKFLOW: Workflow<Parameters<import("./worker/index").WebhookDeliveryWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "AuthSecondaryStorage";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_RATE_LIMIT_ENABLED" | "AUTH_RATE_LIMIT_WINDOW_SECONDS" | "AUTH_RATE_LIMIT_MAX" | "AUTH_SENSITIVE_RATE_LIMIT_WINDOW_SECONDS" | "AUTH_SENSITIVE_RATE_LIMIT_MAX" | "ACCOUNT_LOCKOUT_ENABLED" | "ACCOUNT_LOCKOUT_THRESHOLD" | "ACCOUNT_LOCKOUT_WINDOW_SECONDS" | "ACCOUNT_LOCKOUT_COOLDOWN_SECONDS" | "STRIPE_API_VERSION" | "STRIPE_CREATE_CUSTOMER_ON_SIGN_UP" | "STRIPE_BILLING_REQUIRE_EMAIL_VERIFICATION" | "STRIPE_CHECKOUT_ALLOW_PROMOTION_CODES" | "STRIPE_CHECKOUT_AUTOMATIC_TAX_ENABLED" | "STRIPE_CHECKOUT_BILLING_ADDRESS_COLLECTION" | "STRIPE_CHECKOUT_TAX_ID_COLLECTION_ENABLED" | "STRIPE_BILLING_PLANS" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "ADMIN_EMAILS" | "TRUSTED_ORIGINS" | "EMAIL_FROM" | "AZURE_COMMUNICATION_CONNECTION_STRING" | "AZURE_COMMUNICATION_SMS_FROM" | "CAPTCHA_PROVIDER" | "CAPTCHA_SECRET_KEY" | "CAPTCHA_SITE_KEY" | "CAPTCHA_API_ENDPOINT" | "CAPTCHA_SITE_VERIFY_URL" | "CAPTCHA_MIN_SCORE" | "OAUTH_PROXY_PRODUCTION_URL" | "OAUTH_PROXY_SECRET" | "AGENT_AUTH_PROVIDER_NAME" | "AGENT_AUTH_PROVIDER_DESCRIPTION" | "BRAND_NAME" | "BRAND_ABBREVIATION" | "BRAND_DESCRIPTOR" | "BRAND_LOGO_SRC" | "BRAND_CAPABILITIES" | "BRAND_COLOR" | "BRAND_FOREGROUND_COLOR" | "PRIMARY_COLOR" | "PRIMARY_FOREGROUND_COLOR" | "RING_COLOR" | "OAUTH_CLIENTS" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "X_CLIENT_ID" | "X_CLIENT_SECRET" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET">> {}
}
